...
exports.PluginsPage = class PluginsPage extends MainPage {
  ...
  constructor(page) {
    ...
    this.pluginPanel = page.locator(
      'div[class$="workspace_plugins__plugin-management"]',
    );
    this.closePluginPanelButton = page.locator(
      'button[class$="plugins__close-btn"]',
    );
    this.urlPluginPanelInput = page
      .getByRole('textbox')
      .and(page.getByPlaceholder('Write a plugin URL'));
    this.installPluginPanelButton = page
      .getByRole('button', { name: 'Install' })
      .first();
    this.deletePluginPanelButton = page
    ...
    this.installedPluginPanelListElements = page.locator(
      'div[class$="workspace_plugins__plugins-list-element"]',
    );
    ...
    this.loremPluginPanel = page
      ...
      .locator('div')
      .first();
    this.loremIpsumPluginGenerateButton = page
      .frameLocator('[src*="https://lorem-ipsum-penpot-plugin.pages.dev"]')
