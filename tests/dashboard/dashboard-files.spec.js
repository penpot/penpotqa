...
mainTest(
  qase(55, 'DA-1 Create new file in Drafts on title panel'),
  async ({ page }) => {
    const dashboardPage = new DashboardPage(page);
...
mainTest(
  qase(59, 'DA-5 Rename file in Drafts via right click'),
  async ({ page }) => {
    const dashboardPage = new DashboardPage(page);
    const mainPage = new MainPage(page);
    await dashboardPage.createFileViaPlaceholder();
...
mainTest(
  qase(60, 'DA-6 Rename file (in Drafts) via Options icon'),
  async ({ page }) => {
    const dashboardPage = new DashboardPage(page);
    const mainPage = new MainPage(page);
    await dashboardPage.createFileViaPlaceholder();
...
mainTest(
  qase(61, 'DA-7 Duplicate file in Drafts via right click'),
  async ({ page }) => {
    const dashboardPage = new DashboardPage(page);
    const mainPage = new MainPage(page);
    await dashboardPage.createFileViaPlaceholder();
...
mainTest(
  qase(76, 'DA-22 Delete file in Drafts via right click'),
  async ({ page }) => {
    const dashboardPage = new DashboardPage(page);
    const mainPage = new MainPage(page);
    await dashboardPage.createFileViaPlaceholder();
