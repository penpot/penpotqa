...
demoAccountFileTest(
  qase([2020], 'Compare copied CSS properties with CSS properties in "Inspect" tab'),
  async ({ mainPage }) => {
  ...
  demoAccountApiFixture(
    ...
    async () => {
      await demoAccountApiFixture.step(
        ...
        async () => {
          await demoAccountApiFixture.step('Copy Board 1 properties', async () => {
            await layersPanelPage.selectLayerByName('Board 1');
            await mainPage.clickShortcutCtrlAltC();
          });

          await demoAccountApiFixture.step(
            'Paste properties onto Board 2',
            async () => {
      ...
      await demoAccountApiFixture.step(
        ...
        async () => {
          await demoAccountApiFixture.step('Copy Text 1 properties', async () => {
