...
dashboardTest("Edit profile name", async ({ page }) => {
...
dashboardTest("Logout from Account", async ({ page }) => {
  const profilePage = new ProfilePage(page);
...
dashboardTest("Send feedback email with empty fields", async ({ page }) => {
  const profilePage = new ProfilePage(page);
...
dashboardTest("Send feedback email with valid data", async ({ page }) => {
  const profilePage = new ProfilePage(page);
  await profilePage.openGiveFeedbackPage();
  await profilePage.isHeaderDisplayed("Your account");
  await profilePage.enterSubjectToGiveFeedbackForm("QA Test");
