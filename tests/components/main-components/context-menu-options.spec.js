...
test.describe(() => {
    ...
    mainTest("Show in assets panel option from component context menu", async ({ page }) => {
        const mainPage = new MainPage(page);
    ...
    mainTest("Create annotation with valid text", async ({ page }) => {
        ...
        await expect(mainPage.componentBlockOnDesignTab).toHaveScreenshot("component-annotation.png");
    });
    ...
    mainTest("Cancel annotation creation and accept", async ({ page }) => {
        ...
        await expect(mainPage.componentBlockOnDesignTab).toHaveScreenshot("component-annotation-discard.png");
    });
    ...
    mainTest("Edit annotation with valid text", async ({ page }) => {
        ...
        await expect(mainPage.componentBlockOnDesignTab).toHaveScreenshot("component-annotation-edit.png");
    });
    ...
    mainTest("Delete annotation", async ({ page }) => {
        ...
        await mainPage.waitForChangeIsSaved();
        await expect(mainPage.componentBlockOnDesignTab).toHaveScreenshot("component-annotation-delete.png");
    });
    ...
    mainTest("Annotation on Inspect tab", async ({ page }) => {
        ...
        await expect(mainPage.annotationBlockOnInspect).toHaveScreenshot("component-annotation-inspect-tab.png");
    });
    ...
    mainTest("Duplicate main component", async ({ page }) => {
        ...
        await expect(mainPage.viewport).toHaveScreenshot("component-rectangle-duplicated-canvas.png");
    });
    ...
    mainTest("Check annotation applies for copies and inspect tab", async ({ page }) => {
        const mainPage = new MainPage(page);
        ...
        await expect(mainPage.componentBlockOnDesignTab).toHaveScreenshot("copy-component-annotation.png");
        await mainPage.openInspectTab();
        await mainPage.isAnnotationExistOnInspectTab();
        await expect(mainPage.annotationBlockOnInspect).toHaveScreenshot("component-annotation-inspect-tab.png");
    });
...
mainTest("Check created component group of shapes on Assets tab", async ({ page }) => {
    const mainPage = new MainPage(page);
    const layersPanelPage = new LayersPanelPage(page);
    ...
    await mainPage.waitForChangeIsSaved();
    await expect(mainPage.viewport).toHaveScreenshot("ellipse-complex-component-canvas.png");
    await expect(layersPanelPage.layersSidebar).toHaveScreenshot("ellipse-complex-component-layer.png");
    await mainPage.openAssetsTab();
    await mainPage.expandComponentsBlockOnAssetsTab();
    await mainPage.isComponentAddedToFileLibraryComponents();
    await expect(mainPage.assetsPanel).toHaveScreenshot("ellipse-complex-component-asset.png");
});
...
mainTest("Create a group with component and check its name", async ({ page }) => {
    ...
    await layersPanelPage.openLayersTab();
    await expect(layersPanelPage.layersSidebar).toHaveScreenshot("component-group-layer.png");
...
mainTest("Rename component with valid name", async ({ page }) => {
    ...
    await expect(layersPanelPage.layersSidebar).toHaveScreenshot("component-new-name-layer.png");
});
