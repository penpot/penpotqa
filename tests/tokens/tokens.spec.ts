...
import { TokensComponent } from '../../pages/workspace/tokens/tokens-component';
...
mainTest.beforeEach(async ({ page, browserName }) => {
  ...
  let tokensComp: TokensComponent = new TokensComponent(page);
  let designPanelPage: DesignPanelPage = new DesignPanelPage(page);
  let layersPanelPage: LayersPanelPage = new LayersPanelPage(page);
  let colorPalettePage = new ColorPalettePage(page);
