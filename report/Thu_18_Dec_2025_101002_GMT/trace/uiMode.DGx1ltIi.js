...
var St = (r, t, e) =>
  t in r
    ? bt(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
    : (r[t] = e);
...
import {
  ...
  b as Ft,
  c as Ot,
} from './assets/testServerConnection-CLJOcN3M.js';
var At = {};
class et {
  constructor(t, e = {}) {
    ((this.isListing = !1),
      ...
      a = (n) => {
        ...
        return !i.every((u) => m.includes(u)) &&
          ...
          : ((n.children = n.children.filter(
              (u) =>
                !d || (s == null ? void 0 : s.has(u.test.id)) || e.get(u.status),
            )),
        ...
        (b.children.forEach(j),
          !c &&
            ...
            ((b.kind === 'test' && d.testIds.has(b.test.id)) ||
              (b.kind === 'case' &&
                d.testIds.has((C = b.tests[0]) == null ? void 0 : C.id))) &&
            (c = b));
      };
          ...
          source: {
            errors: t.loadErrors
              .filter((C) => {
                var $;
                return (
                  (($ = C.location) == null ? void 0 : $.file) === c.location.file
                );
              })
          ...
          children: [
            o.jsxs('div', {
              ...
              children: [
                ...
                c.kind === 'case'
                  ? c.tags.map((j) =>
                      o.jsx(Jt, { tag: j.slice(1), onClick: (b) => G(b, j) }, j),
                    )
                  : null,
              ],
            }),
            ...
            o.jsxs(X, {
              ...
              children: [
                ...
                o.jsx(N, {
                  ...
                  onClick: () =>
                    e == null ? void 0 : e.openNoReply({ location: c.location }),
                  style:
                    c.kind === 'group' && c.subKind === 'folder'
                      ? { visibility: 'hidden' }
                      : {},
                }),
                !a &&
                  o.jsx(N, {
                    ...
                    title: 'Watch',
                    onClick: () => {
                      (f.value.has(c.id) ? f.value.delete(c.id) : f.value.add(c.id),
                        n({ ...f }));
                    },
...
const ie = ({ item: r, rootDir: t }) => {
    ...
    return (
      h.useEffect(() => {
        ...
        const p =
          l && l.duration >= 0 && l.attachments.find((T) => T.name === 'trace');
        if (p && p.path) {
        ...
        const x = `${f}/${se(l.workerIndex)}/traces/${(I = r.testCase) == null ? void 0 : I.id}.json`;
        return (
    ...
    (h.useEffect(() => {
      ...
      h.useEffect(() => {
        ...
        return (
          (A.resize = (_, y) => {
            ((ct = { cols: _, rows: y }),
              w.resizeTerminalNoReply({ cols: _, rows: y }));
          }),
          () => {
...
`,
      ...
      h.useEffect(() => {
        ...
        const { config: v, rootSuite: _ } = n,
          y = v.configFile
            ? ut.getObject(v.configFile + ':projects', void 0)
            : void 0,
          S = new Map(a);
        ...
        (!y &&
          S.size &&
          ![...S.values()].includes(!0) &&
          S.set(S.entries().next().value[0], !0),
        ...
        (v, _) => {
          !w ||
            ...
            (b.current = b.current.then(async () => {
              ...
              {
                for (const L of ((B = n.rootSuite) == null
                  ? void 0
                  : B.allTests()) || [])
                  if (y.has(L.id)) {
                    L.results = [];
              ...
              (A.write(
                '\x1B[2m—'.repeat(Math.max(0, ct.cols - S.length)) + S + '\x1B[22m',
              ),
              ...
              for (const L of ((R = n.rootSuite) == null ? void 0 : R.allTests()) ||
                [])
                ((M = L.results[0]) == null ? void 0 : M.duration) === -1 &&
                  (L.results = []);
              (m({ ...n }), U(void 0));
            })));
        },
    ...
    const K = !!T,
      ...
      vt = h.useCallback((v) => {
        ...
        (v.preventDefault(),
          v.stopPropagation(),
          (_ = J.current) == null || _.showModal());
      }, []),
      Z = h.useCallback((v) => {
        var _;
        (v.preventDefault(),
          v.stopPropagation(),
          (_ = J.current) == null || _.close());
      }, []),
      xt = h.useCallback(
        (v) => {
          (Z(v),
            ...
            w == null ||
              w.installBrowsers({}).then(async () => {
                s(!1);
                const { hasBrowsers: _ } = await (w == null
                  ? void 0
                  : w.checkBrowsers({}));
                rt(_);
              }));
