import { n as yu, o as mu } from './testServerConnection-CLJOcN3M.js';
var ga = { exports: {} };
(function (yr, Or) {
  (function (F, Ee) {
    yr.exports = Ee();
...
`,
    ...
    function f(e) {
      ...
      for (var t = e.parent, n = G(t.lines, e), r = t.parent; r; t = r, r = r.parent)
    ...
    function go(e, t, n) {
      if (!t.styles || t.styles[0] != e.state.modeGen) {
        var r = fn(e, f(t)),
          i =
            t.text.length > e.options.maxHighlightLength && Ut(e.doc.mode, r.state),
          o = vo(e, t, r);
        (i && (r.state = i),
    ...
    function ba(e, t, n) {
      for (
        ...
        var s = U(o, a - 1),
          u = s.stateAfter;
        if (u && (!n || a + (u instanceof Bn ? u.lookAhead : 0) <= o.modeFrontier))
          return a;
...
`
    ...
    function Ha(e, t, n) {
      ...
      for (var a = i.length, s = 0, u = 1, d = '', p, m, y = 0, S, N, z, P, W; ; ) {
        if (y == s) {
          ...
          if (P && (P.from || 0) == s) {
            if (
              (zo(t, (P.to == null ? a + 1 : P.to) - s, P.marker, P.from == null),
              P.to == null)
            )
              return;
            P.to == s && (P = !1);
    ...
    function Vo(e) {
      var t = Ur(e.display),
        ...
        r = n && Math.max(5, e.display.scroller.clientWidth / Gr(e.display) - 3);
      return function (i) {
    ...
    function vs(e) {
      ...
      if (o)
        for (var a = 0; a < o.length; ++a) o[a].lines.length || Ge(o[a], 'hide');
      if (l)
        for (var s = 0; s < l.length; ++s) l[s].lines.length && Ge(l[s], 'unhide');
      ...
      for (var s = r.view, u = r.viewFrom, d = 0; d < s.length; d++) {
        ...
        if (!p.hidden)
          if (!p.node || p.node.parentNode != o) {
            ...
            (p.changes && (G(p.changes, 'gutter') > -1 && (y = !1), Eo(e, p, u, n)),
              y &&
                (T(p.lineNumber),
    ...
    function li(e, t, n) {
      (Lt(e, 'beforeSelectionChange') ||
        ...
        (t = As(e, t, n));
      var r =
        (n && n.bias) || (I(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
      (Ll(e, Nl(e, t, r, !0)),
        !(n && n.scroll === !1) &&
          e.cm &&
    ...
    ((pr.prototype.clear = function () {
      ...
      (pr.prototype.detachLine = function (e) {
        if (
          (this.lines.splice(G(this.lines, e), 1), !this.lines.length && this.doc.cm)
        ) {
          var t = this.doc.cm.curOp;
      ...
      for (
        var t = function (r) {
            ...
            for (var l = 0; l < i.markers.length; l++) {
              var a = i.markers[l];
              G(o, a.doc) == -1 && ((a.parent = null), i.markers.splice(l--, 1));
            }
          },
          n = 0;
        n < e.length;
                ...
                a = function () {
                  ++l == i &&
                    rt(t, function () {
                      ...
                      (Jr(t.doc, y), Tl(t.doc, cr(fe(t.doc, n), fe(t.doc, dr(y)))));
                    })();
                },
                s = function (y, S) {
                  if (
...
`,
    ...
    function ou(e, t) {
      return Lt(e, 'gutterContextMenu') ? ra(e, t, 'gutterContextMenu', !1) : !1;
    }
    function ia(e) {
    ...
    function Fn(e, t, n, r) {
      ...
      if ((m < d && (p += ht(d - m)), p != u))
        return (
          Qr(i, p, k(t, 0), k(t, u.length), '+input'),
          (a.stateAfter = null),
          !0
        );
    ...
    function fu(e) {
      ...
      ((e.prototype = {
        ...
        getStateAfter: function (r, i) {
          var o = this.doc;
          return ((r = ho(o, r ?? o.first + o.size - 1)), fn(this, r + 1, i).state);
        },
        ...
        scrollIntoView: pt(function (r, i) {
          (r == null
            ...
            r.to || (r.to = r.from),
            (r.margin = i || 0),
            r.from.line != null ? ss(this, r) : nl(this, r.from, r.to, r.margin));
        }),
...
`)));
      ...
      (Pe.prototype.showPrimarySelection = function () {
        ...
        if (
          !(o && !o.bad && l && !l.bad && I(Hr(o, l), r) == 0 && I(mt(o, l), i) == 0)
        ) {
      ...
      (Pe.prototype.pollSelection = function () {
        if (
          ...
          var e = this.getSelection(),
            t = this.cm;
          if (V && q && this.cm.display.gutterSpecs.length && cu(e.anchorNode)) {
  ...
  (function (F) {
    ...
    F.defineMode('css', function (ee, X) {
      ...
      function Le(w, A, C, be) {
        return (
          (w.context = new gt(C, A.indentation() + (be === !1 ? 0 : T), w.context)),
          C
        );
      }
      function Ke(w) {
      ...
      (function (yr, Or) {
        (function (F) {
          ...
          (F.defineMode('javascript', function (Ee, Se) {
            ...
            function le(f, h) {
              var L = function () {
                ...
                if (O.lexical.type == 'stat') k = O.lexical.indented;
                  ...
                  for (var I = O.lexical; I && I.type == ')' && I.align; I = I.prev)
                    k = I.indented;
            ...
            function ne(f, h) {
              ...
              if (f == 'variable' || T.style == 'keyword') {
                ...
                if (f == 'number' || f == 'string')
                  return (
                    (T.marked = Ce ? 'property' : T.style + ' property'),
                    c(we)
                  );
            ...
            function nr(f) {
              if (_ && f == ':')
                return T.stream.match(/^\s*\w+\s+is\b/, !1) ? c(G, gi, ke) : c(ke);
            }
            function gi(f, h) {
      ...
      function (ie, q) {
        ...
        function ae(V, oe) {
          ...
          if (
            ...
            oe.inTag && ((oe.inTag += V.current()), V.eol() && (oe.inTag += ' '));
          return xe;
        }
        return {
          startState: function () {
  ...
  (function (F) {
      ...
      return {
        ...
        indent: function (R, ne) {
          ...
          if (
            ...
            for (; Y.type == 'statement' && g.dontIndentStatements.test(Y.info); )
              Y = Y.prev;
          if (he.indent) {
    ...
    (me('text/x-kotlin', {
      ...
      me('text/x-objectivec', {
        ...
        builtin: M(se),
        blockKeywords: M(
          ae + ' @synthesize @try @catch @finally @autoreleasepool @synchronized',
        ),
